...
st.markdown(
    """
    <div style="border: 5px solid #ddd; border-radius: 5px; padding: 15px; margin-bottom: 20px;">
        <p style="color:red; font-weight:bold; text-align:center; font-size: 1.8em;">
            Important !
        </p>
        <p style="text-align: justify; font-size: 1.4em;">
            These features leverage the advanced capabilities of the Gemini 2.0 Flash model to deliver state-of-the-art performance and accuracy. Nonetheless, as with all sophisticated technologies, there is a possibility of occasional anomalies in the results. To uphold the highest standards of quality and reliability, we strongly recommend conducting a manual review of all outputs generated by these features.
        </p>
    </div>
    """,
...
st.divider()
st.markdown('### 3. Analisis Koherensi Dokumen <b style="color:yellow;">(Available but still on development)</b>', unsafe_allow_html=True)
