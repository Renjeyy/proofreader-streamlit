...
st.markdown(
    ...
    <div style="border: 5px solid black; border-radius: 5px; padding: 15px; margin-bottom: 20px;">
        ...
        <p style="color:red; text-align: justify; font-size: 1.25em;">
            Jika website membutuhkan waktu lebih dari 5 menit untuk loading, berkabar aja nanti akan dilakukan reboot
        </p>
    </div>
    """,
