...
st.markdown(
    ...
    <div style="border: 5px solid black; border-radius: 5px; padding: 15px; margin-bottom: 20px;">
        ...
        <p style="text-align: justify; font-size: 1.25em;">
            These features leverage the advanced capabilities of the Gemini 2.0 Flash model to deliver state-of-the-art performance and accuracy. Nonetheless, as with all sophisticated technologies, there is a possibility of occasional anomalies / mistakes provided by the AI model. To uphold the highest standards of quality and reliability, We strongly recommend conducting a manual review of all outputs generated by these features.
        </p>
    </div>
    """,
