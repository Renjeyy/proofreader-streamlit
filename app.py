...
st.markdown(
    ...
    <div style="border: 1px solid #ddd; border-radius: 5px; padding: 15px; margin-bottom: 20px;">
        ...
        <p style="text-align: justify;">
            Fitur-fitur ini memanfaatkan kemampuan canggih dari model <b>Gemini 1.5 Pro</b> untuk memberikan kinerja dan akurasi yang modern. Namun, seperti semua teknologi yang canggih, ada kemungkinan anomali sesekali dalam hasilnya. Untuk menjunjung tinggi standar kualitas dan keandalan tertinggi, kami sangat menyarankan untuk melakukan tinjauan manual terhadap semua output yang dihasilkan oleh fitur-fitur ini.
        </p>
    </div>
    """,
